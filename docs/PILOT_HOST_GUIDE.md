...
- [ ] Investigate the Bitdefender protected-files alert reported during that export. The host tentatively recalled Applications; exact wording, affected app and target file/folder, and timing are pending. Successful saving does not resolve the alert.
