...
Local saving and version/build metadata are confirmed by the host's report and supplied artifact. Antivirus compatibility remains unresolved. The host identified Bitdefender and tentatively recalled the Applications folder. The exact alert wording, named app and target file/folder, and whether the alert appeared when opening the Save dialog or after choosing Save remain unknown. No protection setting was changed or recommended, and no false-positive conclusion was made.
