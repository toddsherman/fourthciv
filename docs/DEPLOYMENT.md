...
The source is public under MIT. The native app is a build-from-source prototype with local/ad-hoc signing. A Developer ID, notarized installer, automatic updates, physical two-Mac field testing, and internet peer discovery remain outstanding. The landing page describes those limits and links to build instructions rather than offering an unverified installer.
